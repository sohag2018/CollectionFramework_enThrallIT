...
*Vector increments 100% capacity
*synchronized-1 thread at a time
* and contains many methods that are not the part of Collection framework.


Commonly used methods:
1.boolean add(Object obj): -> true if the specified element is added  successfully into the Vector, otherwise it returns false.
2.void add(int index, Object obj):
3.boolean addAll(Collection c) This method appends all of the elements
in the specified Collection to the end of this Vector. –we can copy ArrlyList value
